...
const val driver = "com.mariadb.jdbc.Driver"
...
class MariaDB(
    ...
    @kotlin.Throws(ClassNotFoundException::class, SQLException::class)
...
fun main(args: Array<String>) {
    ...
    val mysql = MariaDB(hostname, database, port, username, password)
